...
export const generateTimetable = functions.pubsub.schedule('every tuesday 19:48').timeZone('Europe/Ljubljana').onRun(async (context) => {
  try {
    console.log("TESTO")
